---
title: "A companion guide to Jim Hester's, 'You can make an R package in 20 minutes'"
...
- [**usethis**](https://CRAN.R-project.org/package=usethis){target="_blank"}: Automate Package
  and Project Setup. R package version 1.5.1. Hadley Wickham and Jennifer Bryan (2019).

- [**devtools**](https://CRAN.R-project.org/package=devtools){target="_blank"}: Tools
  to Make Developing R Packages Easier. R package version 2.1.0. Hadley Wickham, Jim Hester and Winston Chang (2019). 
  


- [**roxygen2**](https://CRAN.R-project.org/package=roxygen2){target="_blank"}: 
  In-Line Documentation for R. R package version 6.1.1. Hadley Wickham, Peter Danenberg and Manuel Eugster (2018).
...
- [The Note Package I created on Github based on the presentation](https://github.com/EvaMaeRey/note)
- [Hadley Wickham's *R Packages: Chapter II 'The Whole Game'* ](https://r-pkgs.org/whole-game.html){target="_blank"}
